    ...
    <main className="pt-32 pb-24 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          className="mb-6"
        >
          <p className="text-xs font-mono uppercase tracking-[0.18em] text-white mb-4">/ Schoolopdrachten</p>
          <h1
        ...
        >
          ...
          <div className="flex items-center justify-center gap-3 flex-wrap">
            ...
            <a
              href="/contact"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-2xl text-sm font-medium text-[#09090b] transition-all duration-200 hover:opacity-88"
